...
export default function ContactPage() {
  ...
  function handleDebtToggle(debt: string) {
    setForm((prev) => {
      ...
      if (debt === "无") {
        return {
          ...prev,
          existingDebts: current.includes("无") ? [] : ["无"],
        };
      }
  ...
  function validate(): Record<string, string> {
    ...
    if (showPropertyFields && !form.firstHomeBuyer)
      e.firstHomeBuyer = "请选择是否首次购房";
    if (showPropertyFields && !form.propertyBudget)
      e.propertyBudget = "请选择房产价格预算";
          ...
          {status === "success" ? (
            ...
            >
                ...
                <div className="space-y-5">
                  ...
                  {showPropertyFields && (
                    <div className="rounded-xl border border-coral/20 bg-coral/[0.03] p-5 space-y-5">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3" id="firstHomeBuyer">
                          {["是", "否"].map((opt) => (
                            <label
                              key={opt}
                              className={radioChipCls(form.firstHomeBuyer === opt)}
                            >
                              <input
                                type="radio"
                                name="firstHomeBuyer"
                      ...
                      <div>
                        <label
                          htmlFor="propertyBudget"
                          className="block text-sm font-medium text-gray-700 mb-1.5"
                        >
                          房产价格预算 <span className="text-coral">*</span>
                        </label>
                        <select
                          id="propertyBudget"
                          name="propertyBudget"
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3" id="employmentStatus">
                      {["全职受雇", "兼职受雇", "自雇", "其他"].map((opt) => (
                        <label
                          key={opt}
                          className={radioChipCls(form.employmentStatus === opt)}
                        >
                          <input
                            type="radio"
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["无", "有房贷", "有信用卡", "有其他贷款"].map((opt) => (
                        <label
                          key={opt}
                          className={radioChipCls(form.existingDebts.includes(opt))}
                        >
                          <input
                            type="checkbox"
              ...
              <button
                ...
                className="w-full bg-coral hover:bg-coral/90 disabled:opacity-60 disabled:cursor-not-allowed text-white py-4 rounded-lg font-semibold text-base transition-all duration-200 shadow-md"
              >
